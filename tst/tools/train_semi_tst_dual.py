...
def train(
    ...
    for epoch in range(exp.start_epoch, exp.max_epoch):
        ...
        for batch_idx in range(exp.eval_step):
            ...
            unlabel_idxs, (inputs_u_w, inputs_u_s, inputs_u_s1, inputs_u_s2), _ = unlabeled_iter.next()
            ...
            inputs_u_s1 = inputs_u_s1.cuda()
            inputs_u_s2 = inputs_u_s2.cuda()

            inputs = unlabel_idxs, inputs_x, inputs_u_w, inputs_u_s, inputs_u_s1, inputs_u_s2, targets_x
