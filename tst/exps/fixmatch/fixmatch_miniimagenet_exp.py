...
class Exp(BaseExp):
    ...
    def get_data_loader(self):
        ...
        base_dataset = build_dataset(
            self.dataset, self.dataset_root, train=True, return_index=True, transform=transform_labeled
        )
        ...
        test_dataset = build_dataset(
            self.dataset, self.dataset_root, train=False, return_index=False, transform=transform_val
        )
