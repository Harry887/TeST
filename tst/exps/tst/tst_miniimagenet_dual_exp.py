...
from tst.exps.fixmatch.fixmatch_miniimagenet_exp import Exp as FixMatchExp
...
class Exp(FixMatchExp):
    def __init__(self, batch_size, max_epoch=1024):
        ...
        self.transform = "fixmatch_transform_dual_mc"
        self.warmup = 10
        self.window = 10
        self.threshold = 0.95
        self.threshold_lb = 0
        self.threshold_ub = 0.99
        self.threshold_c = 0.7
        self.lambda_u = 10
        self.recall = True
        self.match_low_quality = True
        self.cutout_size = [84, 84, 84]
