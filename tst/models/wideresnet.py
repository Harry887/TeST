"""
@Description  : Modified from https://github.com/kekmodel/FixMatch-pytorch/blob/master/models/wideresnet.py
"""
import logging
...
@BACKBONES.register()
def wideresnet(num_classes, depth, widen_factor, drop_rate):
    logger.info(f"Model: WideResNet {depth}x{widen_factor}")
    return WideResNet(depth=depth, widen_factor=widen_factor, drop_rate=drop_rate, num_classes=num_classes)
